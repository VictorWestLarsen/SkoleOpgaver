...
namespace UnitTestProject
{
    ...
    public class UnitTest1
    {
        ...
        {
            Func<double, double> bonusDel = bon => bon * 0.2;
            Assert.AreEqual(0.0, order.GetTotalPrice(new DateTime(2018, 2, 28), bonusDel));
            Assert.AreEqual(8.0, order.GetTotalPrice(new DateTime(2018, 3, 2), bonusDel));
            Assert.AreEqual(20.0, order.GetTotalPrice(new DateTime(2018, 3, 3), bonusDel));
            Assert.AreEqual(36.0, order.GetTotalPrice(new DateTime(2018, 3, 4), bonusDel));
        }                                                                      
